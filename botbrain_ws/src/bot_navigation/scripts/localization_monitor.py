#!/usr/bin/env python3
"""
Localization drift monitor (Strategy D).
...
class LocalizationMonitor(Node):
    def __init__(self):
        ...
        self.low_count = 0
        self._last_alert_time = 0.0       # cooldown: prevent alert spam
        self._alert_cooldown_sec = 30.0   # minimum seconds between alerts
        ...
        # Cancel-goal publisher (std_msgs/Bool not needed; use action cancel service)
        if self.auto_cancel:
        ...
        self.get_logger().info(
            ...
            f'threshold={self.threshold}, count={self.count_limit}, '
    ...
    def _cb(self, msg: Float32):
        ...
        if confidence < self.threshold:
            ...
            if self.low_count >= self.count_limit:
                ...
                self.low_count = 0  # reset counter after triggering
        else:
            if self.low_count > 0:
                self.get_logger().info(
